...
namespace UnityChess.StrategicAI.Tools
{
	public static class PiecePositionScoreTable
	{
		...
		public static readonly int[] Knights = {
			-40, -35, -30, -30, -30, -30, -35, -40, //8
			-30, -20,   0,   0,   0,   0, -20, -30, //7
			-20,   0,  10,  15,  15,  10,   0, -20, //6
			-20,   5,  15,  20,  20,  15,   5, -20, //5
			-20,   0,  15,  20,  20,  15,   0, -20, //4
			-20,   5,  10,  15,  15,  10,   5, -20, //3
			-30, -20,   0,   5,   5,   0, -20, -30, //2
			-40, -35, -30, -30, -30, -30, -35, -40, //1
		};  //a,   b,   c,   d,   e,   f,   g,   h  //
